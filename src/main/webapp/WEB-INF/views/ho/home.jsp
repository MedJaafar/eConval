...
<div class="page-header">
	...
	Application de Gestion qui Relie les Hopitaux aux Maisons de Convalesneces.
			       ...
			       <div class="well center"    >
											<h2 class="blue bigger lighter center"><i class="ace-icon fa fa-hospital-o" aria-hidden="true"></i>  <strong>${hopital} </strong>interface</h2>
...
<div class="col-sm-6">
										...
										<h1 class ="green"><i class="fa fa-heartbeat"> </i> <strong>e Conval</strong> Hôpital</h1> 
										<p class="lead">
