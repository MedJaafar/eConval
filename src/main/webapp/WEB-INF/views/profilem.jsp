...
<link
	href="<c:url value="/resources/assets/css/jquery-ui.custom.css" />"
	rel="stylesheet" />
<link href="<c:url value="/resources/assets/css/jquery.gritter.css" />"
	rel="stylesheet" />
<link href="<c:url value="/resources/assets/css/select2.css" />"
	rel="stylesheet" />
<link
	href="<c:url value="/resources/assets/css/bootstrap-datepicker3.css" />"
	rel="stylesheet" />
<link
	href="<c:url value="/resources/assets/css/bootstrap-editable.css" />"
	rel="stylesheet" />
...
<script src="<c:url value="/resources/assets/js/ace-extra.js"/>"></script>
									...
									<div class="col-xs-12 col-sm-3 center">
										<div>
											...
											<span class="profile-picture"> <img id="avatar"
												...
												src="${pageContext.request.contextPath}/resources/assets/avatars/profile-pic.jpg" />
											</span>
													...
													<div class="widget-main padding-8">
														...
														<div id="profile-feed-1" class="profile-feed">
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Alex Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar5.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Susan Smith's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar1.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="David Palms's avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar4.png" />
													...
													<div class="profile-users clearfix">
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar4.png" alt="Bob Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar1.png" alt="Rose Doe's avatar" />
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar.png" alt="Jim Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar5.png" alt="Alex Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar2.png" alt="Phil Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar3.png" alt="Susan Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar1.png" alt="Jennifer Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/resources/assets/avatars/avatar3.png" alt="Alexa Doe's avatar" />
																	</a>
																</div>
...
<![endif]-->
		...
		<![endif]-->
						<script
							src="<c:url value="/resources/assets/js/jquery-ui.custom.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/jquery.ui.touch-punch.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/jquery.gritter.js"/>"></script>
						<script src="<c:url value="/resources/assets/js/bootbox.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/jquery.easypiechart.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/date-time/bootstrap-datepicker.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/jquery.hotkeys.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/bootstrap-wysiwyg.js"/>"></script>
						<script src="<c:url value="/resources/assets/js/select2.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/fuelux/fuelux.spinner.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/x-editable/bootstrap-editable.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/x-editable/ace-editable.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/jquery.maskedinput.js"/>"></script>

						<!-- ace scripts -->
						<script
							src="<c:url value="/resources/assets/js/ace/elements.scroller.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.colorpicker.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.fileinput.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.typeahead.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.wysiwyg.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.spinner.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.treeview.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.wizard.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/elements.aside.js"/>"></script>
						<script src="<c:url value="/resources/assets/js/ace/ace.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.ajax-content.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.touch-drag.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.sidebar.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.sidebar-scroll-1.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.submenu-hover.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.widget-box.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.settings.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.settings-rtl.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.settings-skin.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.widget-on-reload.js"/>"></script>
						<script
							src="<c:url value="/resources/assets/js/ace/ace.searchbox-autocomplete.js"/>"></script>
						...
						\
						 <div class="modal-footer center">\
							...
							<button type="button" class="btn btn-sm" data-dismiss="modal"><i class="ace-icon fa fa-times"></i> Cancel</button>\
								...
								$('#user-profile-3').find('input[type=file]')
